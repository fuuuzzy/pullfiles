...
export const ADD_EPISODES_PARENT_FOLDER = `
  ALTER TABLE episodes ADD COLUMN parent_folder TEXT;
`;

export const CREATE_EPISODES_INDEX_PARENT_FOLDER = `
  CREATE INDEX IF NOT EXISTS idx_episodes_parent_folder ON episodes(parent_folder);
`;
